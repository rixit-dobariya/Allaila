<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="Allaila.Admin.AddUser" %>
				...
				<div class="box_account">
					...
					<div class="form_container">
						...
						<div class="text-center">
							<asp:Button ID="btnAddUser" runat="server" Text="Add User" class="btn_1 full-width" ValidationGroup="loginGroup" OnClick="btnAddUser_Click" />
						</div>
